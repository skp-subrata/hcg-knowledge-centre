...
bad_script_start = "const userId = document.getElementById('interest-container').dataset.userid;"
...
content = re.sub(r'<script>\s*const userId = document\.getElementById\(\'interest-container\'\).*?</script>', script_block, content, flags=re.DOTALL)

with open('d:/apps/templates/profile.html', 'w', encoding='utf-8') as f:
    f.write(content)
print("profile.html script patched.")
