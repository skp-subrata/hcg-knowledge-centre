...
# 1. Add Emp ID and Email to users table headers
...
# 2. Add Emp ID and Email to data-search
...
# 3. Add Emp ID and Email to users table rows
...
# 4. Remove literal backslashes from the injected jinja tags
...
# 5. Append the Cleaned editUserModal to the end
edit_user_modal = """
<!-- Edit User Modal -->
...
with open('d:/apps/templates/admin.html', 'w', encoding='utf-8') as f:
    f.write(content)
print("SUCCESS: Fully restored and correctly patched admin.html")
